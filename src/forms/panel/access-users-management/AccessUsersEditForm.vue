...
import { find_data, update_user_access } from '@/services/users_access.service'
export default defineComponent({
    name: 'access-users-edit-form',
    components: {
        Form,
        Field,
        ErrorMessage
    ...
    methods: {
        ...
        handleSubmit: async function (values: any, { resetForm }: any) {
            ...
            const res = await update_user_access(values, this.props.id)
