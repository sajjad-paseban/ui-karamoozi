<template>
    <Form :validation-schema="form.CvtManagerSchema" @submit="handleSubmit">
...
import { CvtManagerSchema } from '@/forms/Schema'
import { handleNumber, Toast } from '@/helpers/Base'
import { get_data as group_get_data } from '@/services/group.service'
import { cvt_manager } from '@/services/convert.service'
export default defineComponent({
    name: 'cvt-manager-form',
    components: {
        Form,
        Field,
        ErrorMessage
    ...
    methods: {
        ...
        handleSubmit: async function (values: any, { resetForm }: any) {
            ...
            const res = await cvt_manager(this.form.params.group_id, this.form.params.file)
