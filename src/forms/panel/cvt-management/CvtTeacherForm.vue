<template>
    <Form :validation-schema="form.CvtTeacherSchema" @submit="handleSubmit">
...
import { CvtTeacherSchema } from '@/forms/Schema'
import { handleNumber, Toast } from '@/helpers/Base'
import { get_data as group_get_data } from '@/services/group.service'
import { cvt_teacher } from '@/services/convert.service'
export default defineComponent({
    name: 'cvt-teacher-form',
    components: {
        Form,
        Field,
        ErrorMessage
    ...
    methods: {
        ...
        handleSubmit: async function (values: any, { resetForm }: any) {
            ...
            const res = await cvt_teacher(this.form.params.group_id, this.form.params.file)
